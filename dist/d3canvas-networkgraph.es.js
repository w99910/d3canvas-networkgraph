  ...
  function P() {
    ...
    for (let C = 0; C <= g.length - 1; C++) {
      ...
      if (O) {
        ...
        c.font = `${K}px serif`, c.fillStyle = ((M = n == null ? void 0 : n.node) == null ? void 0 : M.labelColor) ?? "black", c.fillText(typeof O == "function" ? O(R, C) : typeof O == "boolean" ? R.id : O, R.x - w / 2, R.y + w / 2);
      }
    }
